...
//    @GetMapping("/weather/{baseTime}")
//    public Map<String, Object> getExternalWeather(HttpServletRequest request, @PathVariable String baseTime) {
...
//
//        try {
//            responseMap = externalsService.getExternalWeather(baseTime);
//        }
